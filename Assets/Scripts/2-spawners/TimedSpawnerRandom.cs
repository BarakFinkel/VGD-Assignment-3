...
{
    [Tooltip("The type of game object to spawn.")]
    [SerializeField]
    protected Mover prefabToSpawn;
    
    [Tooltip("The velocity in which to initialize the spawned game object.")]
    [SerializeField]
    protected Vector3 velocityOfSpawnedObject;
    
    [Tooltip("Minimum time between consecutive spawns, in seconds")]
    [SerializeField]
    protected float minTimeBetweenSpawns = 0.2f;
    
    [Tooltip("Maximum time between consecutive spawns, in seconds")]
    [SerializeField]
    protected float maxTimeBetweenSpawns = 1.0f;
    ...
    [SerializeField]
    protected Transform parentOfAllInstances;
